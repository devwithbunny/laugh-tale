...
export default function Hero() {
  return (
    <>
      <NavBar />
      <div className="min-h-screen bg-[#FEFEFE] text-[#000]">
        <div className="bg-[#000]  text-[#FEFEFE] pt-[120px] pb-[50px] px-[24px]">
        ...
        <div className="px-[24px] py-[40px] flex lg:flex-row flex-col  gap-[40px]">
          ...
          <div className="flex flex-col gap-[24px]">
            ...
            <div>
              <button className="border p-[10px] text-[#FEFEFE] bg-[#000]">
                Browse Destinations
              </button>
            </div>
          </div>
